...
public class dbope2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try{
                ...
                String sql = "insert into profiles value(?, ?, ?, ?, ?)";
                PreparedStatement pstm = con.prepareStatement(sql);
                pstm.setInt(1, subid);
                pstm.setString(2, subname);
                pstm.setString(3, subtel);
                pstm.setInt(4, subage);
                pstm.setDate(5,  java.sql.Date.valueOf(subbirthday));
                pstm.executeUpdate();
                out.print("挿入完了<br>");
